...
function init() {
    ...
    function addTexturedSphere() {
        ...
        const backgroundTexture = textureLoader.load('/asset/background1.jpg'); // Replace with the path to your background image
        ...
        // Load Earth texture
        const earthTexture = textureLoader.load('/asset/earth.jpeg'); // Adjust path as needed
        ...
        // Load Moon texture
        const moonTexture = textureLoader.load('/asset/moon.jpg'); // Adjust path as needed
        ...
        const marsGeometry = new THREE.SphereGeometry(5, 32, 32); // Mars is smaller
        // Load Mars texture
        const marsTexture = textureLoader.load('/asset/mars.jpg'); // Adjust path as needed
        ...
        const jupiterTexture = textureLoader.load('/asset/jupiter.jpg'); // Adjust path as needed
        ...
        // Load Venus texture
        const venusTexture = textureLoader.load('/asset/venus.jpg'); // Adjust path as needed
